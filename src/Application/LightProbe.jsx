...
function LightProbeExample() {
  ...
  useEffect(() => {
    ...
    // 1. 환경 맵 설정 (CubeTexture)
    const loader = new THREE.CubeTextureLoader();
     loader.load([
      '/textures/cube/px.jpg', // +X
      '/textures/cube/nx.jpg', // -X
      '/textures/cube/py.jpg', // +Y
      '/textures/cube/ny.jpg', // -Y
      '/textures/cube/pz.jpg', // +Z
      '/textures/cube/nz.jpg'  // -Z
    ], cubeTextere => {
            scene.background = cubeTextere;

    });
   // scene.background = texture; // 씬의 배경에 환경 맵을 설정
